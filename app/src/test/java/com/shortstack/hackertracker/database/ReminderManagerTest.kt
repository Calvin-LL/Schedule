...
class ReminderManagerTest {
    ...
    fun `get event for notification`() = runBlocking {
        val event = FirebaseEvent(12, "con", "event", begin = "2020-01-01T00:20:00.000-0000", end =  "2020-01-01T00:20:00.000-0000").toLocal()
    ...
    fun `don't set reminder if less than 20 minutes`() {
        val event = FirebaseEvent(12, "con", "event", begin = "2020-01-01T00:05:00.000-0000", end =  "2020-01-01T00:20:00.000-0000").toLocal()
    ...
    fun `update reminder when event is updated`() {
        val event = FirebaseEvent(12, "con", "event", begin = "2020-01-01T00:20:00.000-0000", end =  "2020-01-01T00:20:00.000-0000").toLocal()
        val updated = FirebaseEvent(12, "con", "event", begin = "2020-01-01T00:25:00.000-0000", end =  "2020-01-01T00:20:00.000-0000").toLocal()
